...
public class ThriftTestObject implements org.apache.thrift.TBase<ThriftTestObject, ThriftTestObject._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftTestObject> {
  ...
  public java.util.List<java.lang.Double> field1; // required
  ...
  public ThriftTestObject(
    java.util.List<java.lang.Double> field1)
  {
    this();
    this.field1 = field1;
  }
  ...
  public ThriftTestObject(ThriftTestObject other) {
    if (other.isSetField1()) {
      java.util.List<java.lang.Double> __this__field1 = new java.util.ArrayList<java.lang.Double>(other.field1);
  ...
  public java.util.Iterator<java.lang.Double> getField1Iterator() {
    return (this.field1 == null) ? null : this.field1.iterator();
  }

  public void addToField1(double elem) {
    if (this.field1 == null) {
      this.field1 = new java.util.ArrayList<java.lang.Double>();
    }
    this.field1.add(elem);
  }

  public java.util.List<java.lang.Double> getField1() {
    return this.field1;
  }

  public ThriftTestObject setField1(java.util.List<java.lang.Double> field1) {
    this.field1 = field1;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FIELD1:
      if (value == null) {
        ...
        setField1((java.util.List<java.lang.Double>)value);
      }
      break;
  ...
  private static class ThriftTestObjectStandardScheme extends org.apache.thrift.scheme.StandardScheme<ThriftTestObject> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.field1 = new java.util.ArrayList<java.lang.Double>(_list0.size);
                double _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftTestObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.field1 != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, struct.field1.size()));
          for (double _iter3 : struct.field1)
          {
      ...
      if (struct.isSetField1()) {
        {
          ...
          for (double _iter4 : struct.field1)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.field1 = new java.util.ArrayList<java.lang.Double>(_list5.size);
          double _elem6;
