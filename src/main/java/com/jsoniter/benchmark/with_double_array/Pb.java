package com.jsoniter.benchmark.with_double_array;// Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: Pb.proto
...
public final class Pb {
  ...
  public interface PbTestObjectOrBuilder extends
    ...
    /**
     * <code>repeated double field1 = 1 [packed = true];</code>
     */
    java.util.List<java.lang.Double> getField1List();
    /**
     * <code>repeated double field1 = 1 [packed = true];</code>
     */
    int getField1Count();
  ...
  public  static final class PbTestObject extends
          ...
          switch (tag) {
            ...
            case 9: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                field1_ = new java.util.ArrayList<java.lang.Double>();
                mutable_bitField0_ |= 0x00000001;
              }
              field1_.add(input.readDouble());
              break;
            }
            case 10: {
    ...
    private java.util.List<java.lang.Double> field1_;
    /**
     * <code>repeated double field1 = 1 [packed = true];</code>
     */
     ...
     * <code>repeated double field1 = 1 [packed = true];</code>
     */
    public double getField1(int index) {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < field1_.size(); i++) {
        output.writeDoubleNoTag(field1_.get(i));
      }
    }
    ...
    public static final class Builder extends
      ...
      private java.util.List<java.lang.Double> field1_ = java.util.Collections.emptyList();
      private void ensureField1IsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          field1_ = new java.util.ArrayList<java.lang.Double>(field1_);
       ...
       * <code>repeated double field1 = 1 [packed = true];</code>
       */
      public Builder addField1(double value) {
        ensureField1IsMutable();
        field1_.add(value);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\001B\002\020\001B\002H\001b\006proto3"
    };
