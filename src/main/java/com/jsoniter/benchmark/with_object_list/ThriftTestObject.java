...
public class ThriftTestObject implements org.apache.thrift.TBase<ThriftTestObject, ThriftTestObject._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftTestObject> {
  ...
  public java.util.List<ThriftElementObject> field1; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD1, new org.apache.thrift.meta_data.FieldMetaData("field1", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ThriftElementObject.class))));
  ...
  public ThriftTestObject(
    java.util.List<ThriftElementObject> field1)
  {
    this();
    this.field1 = field1;
  }
  ...
  public ThriftTestObject(ThriftTestObject other) {
    if (other.isSetField1()) {
      java.util.List<ThriftElementObject> __this__field1 = new java.util.ArrayList<ThriftElementObject>(other.field1.size());
      for (ThriftElementObject other_element : other.field1) {
        __this__field1.add(new ThriftElementObject(other_element));
      }
  ...
  public java.util.Iterator<ThriftElementObject> getField1Iterator() {
    return (this.field1 == null) ? null : this.field1.iterator();
  }

  public void addToField1(ThriftElementObject elem) {
    if (this.field1 == null) {
      this.field1 = new java.util.ArrayList<ThriftElementObject>();
    }
    this.field1.add(elem);
  }

  public java.util.List<ThriftElementObject> getField1() {
    return this.field1;
  }

  public ThriftTestObject setField1(java.util.List<ThriftElementObject> field1) {
    this.field1 = field1;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FIELD1:
      if (value == null) {
        ...
        setField1((java.util.List<ThriftElementObject>)value);
      }
      break;
  ...
  private static class ThriftTestObjectStandardScheme extends org.apache.thrift.scheme.StandardScheme<ThriftTestObject> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.field1 = new java.util.ArrayList<ThriftElementObject>(_list0.size);
                ThriftElementObject _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new ThriftElementObject();
                  _elem1.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftTestObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.field1 != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.field1.size()));
          for (ThriftElementObject _iter3 : struct.field1)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetField1()) {
        {
          ...
          for (ThriftElementObject _iter4 : struct.field1)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.field1 = new java.util.ArrayList<ThriftElementObject>(_list5.size);
          ThriftElementObject _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new ThriftElementObject();
            _elem6.read(iprot);
            struct.field1.add(_elem6);
          }
        }
        struct.setField1IsSet(true);
      }
